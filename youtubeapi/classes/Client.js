...
class Client {
	constructor(options = {}) {
		const fullOptions = Object.assign(
			Object.assign(
				{ cookie: "", https: true, requestOptions: {} },
				options
			),
			{
				youtubeClientOptions: Object.assign(
					{ hl: "en", gl: "US" },
	...
	getPlaylist(playlistIdOrUrl) {
		var _a, _b, _c;
		return __awaiter(this, void 0, void 0, function* () {
			const playlistId = common_1.getQueryParameter(
				playlistIdOrUrl,
				"list"
			);
			if (playlistId.startsWith("RD")) {
				...
				return new _1.MixPlaylist({ client: this }).load(
					response?.data
				);
			}
			const response = yield this.http.post(
				`${constants_1.I_END_POINT}/browse`,
				{
			...
			if (
				...
				((_c =
					(_b =
						(_a = response?.data.alerts) === null || _a === void 0
							? void 0
							: _a.shift()) === null || _b === void 0
						? void 0
						: _b.alertRenderer) === null || _c === void 0
					? void 0
					: _c.type) === "ERROR"
			) {
				return undefined;
