	...
	nextComments(count = 1) {
		return __awaiter(this, void 0, void 0, function* () {
			...
			for (let i = 0; i < count || count == 0; i++) {
				...
				const endpoints =
					response.data.onResponseReceivedEndpoints.pop();
				const continuationItems = (
					endpoints.reloadContinuationItemsCommand ||
					endpoints.appendContinuationItemsAction
				).continuationItems;
				this.commentContinuation =
					common_1.getContinuationFromItems(continuationItems);
				const comments = common_1.mapFilter(
					continuationItems,
